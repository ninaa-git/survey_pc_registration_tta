"""
test.py — Registration evaluation.

--mode standard   No adaptation, original pretrained backbone (--snapshot).
--mode pointtta   Point-TTA Algorithm 1 with reconstruction auxiliary task.
                  Loads --meta_snapshot from the meta phase of trainval.py.

Examples:
    python test.py --mode standard \
        --snapshot ../../pretrain/3dmatch.pth.tar

    python test.py --mode pointtta \
        --meta_snapshot /path/to/best_model.pth.tar --niter 5 --lr 2.5e-5
"""
