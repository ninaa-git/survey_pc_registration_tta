...
class Trainer(EpochBasedTrainer):
    def __init__(self, cfg):
        super().__init__(cfg, parser=make_hyperparameters_training_parser("Optuna Hyperparameters Tuning"), max_epoch=cfg.optim.max_epoch, run_grad_check=False, autograd_anomaly_detection=False)
