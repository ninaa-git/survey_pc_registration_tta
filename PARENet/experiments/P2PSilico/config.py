...
_C.dataset_name = os.environ.get("TTA_DATASET", "P2PSilico")
...
ensure_dir(_C.ft_validation_dir)
ensure_dir(_C.viz_dir)
# data
_C.data = edict()
_C.data.dataset_root = '../../../data/P2P/Dataset'
_C.data.cor_dataset_root = '../../../data/corruptions/data/datasets'
...
_C.train.augmentation_noise = 5 #0.005
...
_C.train.max_vis = 1.0
_C.train.min_vis = 0.18
_C.train.overfit = False
_C.train.n_val_ratio = 0.2
_C.train.val_seed = 10
...
_C.backbone.init_voxel_size = 0.02 #0.025
